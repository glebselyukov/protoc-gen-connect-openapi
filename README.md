...
[![Go](https://github.com/glebselyukov/protoc-gen-connect-openapi/actions/workflows/go.yml/badge.svg)](https://github.com/glebselyukov/protoc-gen-connect-openapi/actions/workflows/go.yml) [![Go Report Card](https://goreportcard.com/badge/github.com/glebselyukov/protoc-gen-connect-openapi)](https://goreportcard.com/report/github.com/glebselyukov/protoc-gen-connect-openapi) [![Go Reference](https://pkg.go.dev/badge/github.com/glebselyukov/protoc-gen-connect-openapi.svg)](https://pkg.go.dev/github.com/glebselyukov/protoc-gen-connect-openapi)
...
- Has [an easy interface](https://pkg.go.dev/github.com/glebselyukov/protoc-gen-connect-openapi/converter) for generating OpenAPI specs in-process for Go
...
### Binaries
You can download pre-built binaries from the [Github releases page](https://github.com/glebselyukov/protoc-gen-connect-openapi/releases/latest).
...
```shell
go install github.com/glebselyukov/protoc-gen-connect-openapi@latest
...
version: v2
plugins:
  - local: ["go", "run", "github.com/glebselyukov/protoc-gen-connect-openapi@latest"]
    out: gen
```
...
```
go get -tool github.com/glebselyukov/protoc-gen-connect-openapi@latest
...
| path                       | `{filepath}` | Output filepath, defaults to per-proto file output if not given.  When using [buf](https://github.com/bufbuild/buf), generating multiple files to the same path requires additional configuration to avoid overwriting files. See [#159](https://github.com/glebselyukov/protoc-gen-connect-openapi/issues/159).                                                                            |
